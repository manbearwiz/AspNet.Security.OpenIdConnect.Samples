...
.PARAMETER Clean
Removes the image mvc.client and kills all containers based on that image.
...
Build a Docker image named mvc.client
#>
...
$imageName="mvc.client"
$projectName="mvcclient"
$serviceName="mvc.client"
