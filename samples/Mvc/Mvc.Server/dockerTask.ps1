...
.PARAMETER Clean
Removes the image mvc.server and kills all containers based on that image.
...
Build a Docker image named mvc.server
#>
...
$imageName="mvc.server"
$projectName="mvcserver"
$serviceName="mvc.server"
